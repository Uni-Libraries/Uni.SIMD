...
void PowerSpectrumCF32F32_generic(float* dst, const std::complex<float>* src, size_t len, float normalization_factor) noexcept;
void PowerSpectralDensityCF32F32_generic(float* dst, const std::complex<float>* src, size_t len, float normalization_factor, float rbw_hz) noexcept;
