...
void PowerSpectrumCF32F32_sse2(float* dst, const void* src, size_t len, float normalization_factor) noexcept;
void PowerSpectralDensityCF32F32_sse2(float* dst, const void* src, size_t len, float normalization_factor, float rbw_hz) noexcept;
} // namespace uni::simd::detail
